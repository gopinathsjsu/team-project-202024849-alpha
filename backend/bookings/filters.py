...
class BookingFilter(django_filters.FilterSet):
    ...
    min_party_size = django_filters.NumberFilter(field_name='party_size', lookup_expr='gte')
    max_party_size = django_filters.NumberFilter(field_name='party_size', lookup_expr='lte')
